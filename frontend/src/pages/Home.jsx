    ...
    <div className="relative space-y-12 overflow-hidden py-10 min-h-[70vh] flex flex-col justify-center">
      ...
      <div className="relative text-center max-w-3xl mx-auto">
        ...
        <p className="text-base text-gray-500 max-w-2xl mx-auto leading-relaxed">
          ...
          nhà trường. Chào mừng bạn đến với bảng điều khiển chính.
        </p>
      </div>

      {/* KHU VỰC CÁC CHỨC NĂNG CHÍNH */}
      {/* Cập nhật grid-cols thành 3 để chứa thêm card Giảng viên */}
      <div className="relative grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto w-full px-4">
        ...
        <Link to="/students" className="group">
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/30 hover:shadow-indigo-100/50 hover:border-indigo-100 transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full">
            ...
            <p className="text-sm text-gray-500 grow">
              Xem danh sách, chỉnh sửa hồ sơ và phân chia lớp học cho từng sinh viên trong hệ thống.
            </p>
        ...
        {/* Card 2: Quản lý giảng viên (MỚI THÊM) */}
        <Link to="/Teacher" className="group">
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/30 hover:shadow-blue-100/50 hover:border-blue-100 transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Giảng Viên</h3>
            <p className="text-sm text-gray-500 grow">
              Quản lý thông tin giảng viên, cấp quyền truy cập và theo dõi các học phần giảng dạy.
            </p>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/30 flex flex-col h-full opacity-75">
            ...
            <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center mb-5">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m0 11v1m5-12h2a2 2 0 012 2v2m-2 4h2a2 2 0 012 2v2m-16-10h-2a2 2 0 00-2 2v2m2 4h-2a2 2 0 00-2 2v2m16-12V6a2 2 0 00-2-2h-2m-8 0H6a2 2 0 00-2 2v2m16 4h-2a2 2 0 01-2-2V6M6 20h2a2 2 0 002-2v-2m4 4h2a2 2 0 002-2v-2" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-gray-600 mb-2">Điểm Danh</h3>
            <p className="text-sm text-gray-400 grow">
              Quét mã QR giới hạn thời gian thực để ghi nhận sự hiện diện của sinh viên trong các buổi học.
            </p>

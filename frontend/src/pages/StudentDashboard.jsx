    ...
    <div className="space-y-8 py-10 min-h-[70vh]">
      <div className="rounded-3xl border border-gray-100 bg-white p-10 shadow-xl shadow-gray-200/40">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-indigo-600 font-bold">Trang sinh viên</p>
            <h1 className="text-4xl font-extrabold text-gray-900 mt-3">Xin chào, {user.name || "Sinh viên"}</h1>
            <p className="mt-4 text-gray-500 max-w-2xl leading-relaxed">
              Đây là trang điều khiển sinh viên. Bạn có thể quét mã QR để điểm danh, xem lịch sử điểm danh cá nhân và theo dõi thông tin hồ sơ.
            </p>
          </div>
          <div className="rounded-3xl bg-indigo-600 px-6 py-5 text-white shadow-lg shadow-indigo-200/30">
            <p className="text-xs uppercase tracking-[0.3em] text-indigo-100">Quyền</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 space-y-4 text-sm text-gray-600">
            <div>
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400">Họ tên</div>
              <div className="mt-2 font-bold text-gray-900">{user.name || "Chưa có"}</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400">Email</div>
              <div className="mt-2 font-bold text-gray-900">{user.email || "Chưa có"}</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400">Mã sinh viên</div>
              <div className="mt-2 font-bold text-gray-900">{user.student_code || user.login_id || "Chưa có"}</div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <p className="mt-4 text-gray-500 leading-relaxed">
            Tích hợp camera quét mã QR và gửi kèm tọa độ GPS từ trình duyệt. Chọn chức năng bên dưới để điểm danh và xem lịch sử.
          </p>
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-900">Hướng dẫn nhanh</h3>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-900">Tình trạng hiện tại</h3>
          <div className="mt-6 space-y-4 text-sm text-gray-600">
            <div className="rounded-3xl bg-gray-50 p-4">
              <p className="font-semibold text-gray-900">Camera</p>
              <p className="mt-2">Sử dụng trực tiếp để quét mã QR và giải mã nhanh.</p>
            </div>
            <div className="rounded-3xl bg-gray-50 p-4">
              <p className="font-semibold text-gray-900">GPS</p>
              <p className="mt-2">Tự động lấy tọa độ trình duyệt khi gửi điểm danh.</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <ul className="mt-4 space-y-3 text-sm text-gray-600">
            ...
            <li>Có thể dán nội dung QR thủ công nếu camera không tương thích.</li>
          </ul>
        </div>
      </div>
    </div>
